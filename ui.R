              ...
              tabPanel("Design", id = "design",
               ...
               Usage is as follows:"
                       ...
                       Large upper bounds may cause issues, so transforming X to another scale maybe helpful"),
                         ...
                         tags$li("Choose a \\(\\lambda\\) value to set the relative importance of each objective. Note that \\(\\lambda = 0\\) denotes a D-optimal design while \\(\\lambda = 1\\) denotes a c-optimal design."),
